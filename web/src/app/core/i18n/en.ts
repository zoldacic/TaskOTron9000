...
export const en = {
  ...
  'confirm.deleteBudget.title': 'Delete budget?',
  'confirm.deleteBudget.message': 'Do you really want to delete {name}?{note} This can’t be undone.',
  'confirm.deleteBudget.confirm': 'Delete budget',
  'confirm.deleteBudget.noteOne': ' Its {count} item will be removed too.',
  'confirm.deleteBudget.noteMany': ' Its {count} items will be removed too.',
  'confirm.thisBudget': 'this budget',
  'confirm.deleteBudgetItem.title': 'Delete budget item?',
  'confirm.deleteBudgetItem.message': 'Do you really want to delete {name}? This can’t be undone.',
  'confirm.deleteBudgetItem.confirm': 'Delete item',
  'confirm.thisBudgetItem': 'this item',
  ...
  // ---- planning / budgets ----
  'budget.title': 'Planning',
  'budget.sub': 'Plan what you mean to spend. Budget items are kept apart from your real money — they never show up in the spending report.',
  'budget.new': 'New budget',
  'budget.empty.title': 'Nothing planned yet',
  'budget.empty.body': 'Create a budget for a month, a trip or a renovation. Nothing you put in it touches your tasks or the spending report.',
  'budget.itemsCount': '{count} items',
  'budget.itemCount': '{count} item',
  'budget.range': '{from} → {to}',
  'budget.open': 'Open budget',
  'budget.edit': 'Edit budget',
  'budget.delete': 'Delete budget',
  'budget.back': 'All budgets',
  'budget.addItem': 'Add item',
  'budget.editItem': 'Edit item',
  'budget.deleteItem': 'Delete item',
  'budget.col.item': 'Item',
  'budget.col.category': 'Category',
  'budget.col.amount': 'Amount',
  'budget.noItems.title': 'No items yet',
  'budget.noItems.body': 'Add what you expect — rent, groceries, a flight. Minus for spending, plus for income.',
  'budget.plannedIn': 'Planned in',
  'budget.plannedOut': 'Planned out',
  'budget.plannedNet': 'Planned net',
  'budget.total': 'Total',
  'budget.uncategorized': 'Uncategorized',
  'budget.noCategory': 'No category',
  'budget.vsActual': 'Planned vs actual',
  'budget.vsActualHint': 'Actual figures come from your real tasks dated inside this budget’s range — the same numbers the spending report shows. Nothing here changes them.',
  'budget.byMain': 'Categories',
  'budget.bySub': 'Sub-categories',
  'budget.col.planned': 'Planned',
  'budget.col.actual': 'Actual',
  'budget.col.diff': 'Difference',
  'budget.compareEmpty': 'Nothing planned and nothing spent in this range yet.',
  'budget.over': 'over',
  'budget.under': 'under',
  'budget.onPlan': 'on plan',
  'budget.error.load': 'Couldn’t load that budget.',
  'budget.error.save': 'Couldn’t save. Check the backend log and try again.',

  // ---- budget dialogs ----
  'dialog.budget.new': 'New budget',
  'dialog.budget.edit': 'Edit budget',
  'dialog.budget.name': 'Name',
  'dialog.budget.namePlaceholder': 'Autumn 2026',
  'dialog.budget.from': 'From',
  'dialog.budget.to': 'To',
  'dialog.budget.rangeHint': 'The window this plan covers, and the window its actual figures are summed over.',
  'dialog.budget.rangeError': 'The from date must not be after the to date.',
  'dialog.budget.save': 'Save budget',
  'dialog.budgetItem.new': 'New budget item',
  'dialog.budgetItem.edit': 'Edit budget item',
  'dialog.budgetItem.itemLabel': 'Item',
  'dialog.budgetItem.titlePlaceholder': 'Groceries',
  'dialog.budgetItem.amount': 'Amount',
  'dialog.budgetItem.amountHint': 'minus = spend, plus = income',
  'dialog.budgetItem.amountPlaceholder': '-4000',
  'dialog.budgetItem.pricing': 'Quantity × unit price',
  'dialog.budgetItem.optional': 'optional',
  'dialog.budgetItem.quantity': 'Quantity',
  'dialog.budgetItem.unitPrice': 'Unit price',
  'dialog.budgetItem.pricingHint': 'Fill in both and the amount is worked out for you.',
  'dialog.budgetItem.computed': 'Amount: {amount}',
  'dialog.budgetItem.category': 'Category',
  'dialog.budgetItem.categoryHint': 'optional — needed to compare against actual spending',
  'dialog.budgetItem.subcategories': 'Sub-categories',
  'dialog.budgetItem.note': 'Note',
  'dialog.budgetItem.notePlaceholder': 'Anything worth remembering',
  'dialog.budgetItem.delete': 'Delete item',
  'dialog.budgetItem.save': 'Save item',
